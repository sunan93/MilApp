<%-- 
    Document   : ansQues
    Created on : 7 Mar, 2015, 3:54:25 PM
    Author     : User
--%>
...
<% int userid=-1;
         ...
         /*   int clubid=-1;
            ...
            int qid=-1;
            String qstr=(String)request.getParameter("qid");
            try{
                qid=Integer.parseInt(qstr);
            }
            catch(Exception e)
            {
                   qid=-1;
...
<form class="form-horizontal" style="margin:0 auto;" action="SubmitAnsServlet?qid=<%=qid%>" method="POST">
